...
class ProposedAction(BaseModel):
    ...
    assignee_name: str | None = Field(None, description="The name of the assignee.")
    ...
    scheduled_end_time: str | None = Field(
        None,
    ...
    location: str | None = Field("Discord Server", description="Location of the event.")
