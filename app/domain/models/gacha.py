...
class GachaPetDesign(BaseModel):
    ...
    stage1: EvolutionStage = Field(description="Stage 1 (baby/basic form) design details")
    stage2: EvolutionStage = Field(description="Stage 2 (evolved/mid form) design details")
    stage3: EvolutionStage = Field(description="Stage 3 (final/epic form) design details")
    mega: Optional[EvolutionStage] = Field(None, description="Mega form design details (None/null if not capable)")
